          ...
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-800/60 p-6 shadow-lg">
            <div
              ...
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  <TestimonialCmp isActive={isActive} key={`${testimonial.name}-${index}`} testimonial={testimonial} />
                );
              })}
            </div>
...
const TestimonialCmp: FC<{testimonial: Testimonial; isActive: boolean}> = memo(
